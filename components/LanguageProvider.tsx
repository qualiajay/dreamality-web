...
const dictionary = {
  en: {
    ...
    // Features
    "feature.record.title": "Record every dream, instantly",
    "feature.record.desc": "Capture fleeting dreams right after waking up through voice or text. Your personal dream journal, always ready.",
    "feature.card.title": "Transform memories into art",
    "feature.card.desc": "Transform your fragmented memories into beautiful visual artifacts with our advanced rendering engine.",
    ...
    "how.step1.title": "Record",
    "how.step1.desc": "Speak or type your dream upon waking",
    "how.step2.title": "Generate",
    "how.step2.desc": "Create a beautiful dream card",
  ...
  zh: {
    ...
    // Features
    "feature.record.title": "支持语音输入，记下转瞬即逝的梦",
    "feature.record.desc": "支持语音输入，记下转瞬即逝的梦。醒来的第一时间，轻松留住所有细节。",
    "feature.card.title": "记录每一个梦，生成专属梦境卡片",
    "feature.card.desc": "将你零碎的梦境记忆，转化为绝美的视觉卡片，永久保存。",
    ...
    // How it works
    "how.title": "探索之旅",
    "how.step1.title": "记录梦境",
    "how.step1.desc": "醒来时快速记录",
    "how.step2.title": "生成卡片",
    "how.step2.desc": "绝美的视觉具象化",
